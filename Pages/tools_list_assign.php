...
<html>
<head>
    <meta charset="utf-8"><title>Tools</title>
    <link rel="stylesheet" href="../Styles/style.css">
    <link rel="stylesheet" href="../Styles/tools_list_assign.css">
</head>
<body>
<?php include "../nav.php"; ?>
...
<form method="post">
    ...
    <button type="submit" name="assign" class="Assign_btn">Assign</button>
</form>
</div>
</body>
</html>