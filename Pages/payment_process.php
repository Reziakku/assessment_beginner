...
<html>
<head>
    <meta charset="utf-8"><title>Process Payment</title>
    <link rel="stylesheet" href="../Styles/style.css">
    <link rel="stylesheet" href="../Styles/payment_process.css">
...
<form method="post">
    ...
    <button type="submit" name="pay" class="save_payment">Save Payment</button>
</form>
</div>
</body>
</html>