...
<html>
<head>
    <meta charset="utf-8"><title>Create Booking</title>
    <link rel="stylesheet" href="../Styles/style.css">
    <link rel="stylesheet" href="../Styles/bookings_create.css">
</head>
<body>
<?php include "../nav.php"; ?>
...
<form method="post">
    ...
    <button type="submit" name="create" class="submit_bookings">Create Booking</button>
</form>
</div>
</body>
</html>